...
const generatePassword = (getLetterLowerCase, getLetterUperCase, getNumber, getSymbols) => {
    let password = ""
...
generatePasswordButton.addEventListener("click", (e) => {
    e.preventDefault()
    generatePassword(getLetterLowerCase, getLetterUperCase, getNumber, getSymbols)
})
